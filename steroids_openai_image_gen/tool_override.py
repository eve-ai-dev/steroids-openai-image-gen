    ...
    return {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "mask_url": {"type": "string", "description": "Optional same-size PNG alpha mask for localized editing; transparent pixels are editable."},
                "input_fidelity": {"type": "string", "enum": ["low", "high"], "description": "Optional source fidelity for image edits."},
            },
            "required": ["prompt"],
        },
    }
